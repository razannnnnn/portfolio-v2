...
const allProjectsData = [
  { num: '01', category: 'Full Stack', name: 'HostImgAjaa', link: 'https://hostimgajaa.razan.web.id', image: 'https://hostimgaja.razn.my.id/api/i/8389bb21-e1f2-432f-9310-fe23f51dc481.png', desc: 'Platform image hosting gratis dengan upload Cloudinary, autentikasi NextAuth, dan animasi WebGL.', tags: [{ label: 'Next.js', color: 'bg-[var(--blue)]' }, { label: 'MongoDB', color: 'bg-[var(--green)]' }, { label: 'Cloudinary', color: 'bg-[var(--red)]' }], bgClass: 'bg-[var(--blue)]', thumbLabel: 'IMG' },
  { num: '02', category: 'Full Stack', name: 'PromptBetter', link: 'https://promptbetter-nine.vercel.app', image: 'https://hostimgaja.razn.my.id/api/i/e4a22f08-b56e-4a5c-a2a0-563014ab66b9.png', desc: 'Website untuk mengubah prompt biasa menjadi luar biasa', tags: [{ label: 'Next.js', color: 'bg-[var(--blue)]' }, { label: 'MongoDB', color: 'bg-[var(--green)]' }, { label: 'GROQ AI', color: 'bg-[var(--red)]' }, { label: 'Tailwind', color: 'bg-[var(--blue)]' }], bgClass: 'bg-[var(--red)]', thumbLabel: 'QUIZ' },
  { num: '03', category: 'Frontend', name: 'NgopiDiBlitar', link: 'https://ngopidiblitar.my.id', image: 'https://hostimgaja.razn.my.id/api/i/ae762bbc-0f75-4143-8bb0-d714ea765b08.png', desc: 'Halaman rekomendasi dan list cafe-cafe di Kota Blitar', tags: [{ label: 'Next.js', color: 'bg-[var(--green)]' }, { label: 'Tailwind', color: 'bg-[var(--blue)]' }, { label: 'Google Sheets API', color: 'bg-[var(--green)]' }], bgClass: 'bg-[var(--green)]', thumbLabel: 'LAND' },
  { num: '04', category: 'Full Stack', name: 'RumahFilm', link: 'https://rumahfilm.razan.web.id', image: 'https://hostimgaja.razn.my.id/api/i/5e05508d-0031-4574-8701-e46269e9e976.png', desc: 'Platform streaming film online bersih, nyaman, gratis', tags: [{ label: 'Next.js', color: 'bg-[var(--green)]' }, { label: 'Tailwind', color: 'bg-[var(--blue)]' }], bgClass: 'bg-[var(--green)]', thumbLabel: 'LAND' },
]
